...
export default function YoutuberCard({name, userPFP, onClick, editUsers, handleUserRemoved}) {
  ...
  return (
    <div>
      ...
      <div className={editUsers ? "user-card card-disabled": 'user-card user-card-hover'} onClick={onClick}>
